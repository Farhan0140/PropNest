...
const UserLogin = ({showLoginPassword, toggleLoginPassword}) => {
  return (
    <div className="absolute inset-0 w-full h-full backface-hidden bg-white border-2 border-[#323232] shadow-[4px_4px_0px_0px_#323232] rounded p-5 flex flex-col items-center justify-center gap-5">
      <h2 className="text-2xl font-black text-[#323232] mb-2">Log in</h2>
