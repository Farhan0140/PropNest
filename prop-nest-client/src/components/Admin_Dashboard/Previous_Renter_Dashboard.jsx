...
const Previous_Renter_Dashboard = () => {
  ...
  const filteredRenters = renters.filter(renter => {
    ...
    if (renter.status !== "left") return false;
  ...
  return (
    <div className="font-sans md:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="mb-2">
          <h1 className="text-3xl font-bold text-black mb-2">Left Renters History</h1>
          <p className="text-gray-600 text-lg">Manage all left renters and their information</p>
        </div>
...
export default Previous_Renter_Dashboard;
